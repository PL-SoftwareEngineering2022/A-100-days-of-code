...
3. # Float: numbers with decimals. short for floating point number eg. 3.14159
print(3.14 + 5.66)
    # 8.8

4. # Boolean: True or False. Capital first letters and no quotation marks around them.
...
6/3
    # 2.0
#exponents: raising a number to the power of n: eg. 2 to the power of 8:
2**8
    # 256

# when using more than one formula in a function, then the priority order of operation (PEMDAS) applies: Parentheses, Exponents, Multiplication, Division, Addition, Subtraction:or (PEMDASLR) because it reads from left to right. also because Multiplication and division; and addition/substraction will be applied from left to right because they hold the same level of importance.
print(3*3+3/3-3)
    # 7.0
print(3*(3+3)/3-3)
    # 3.0
...
# The BMI is calculated by dividing a person's weight (in kg) by the square of their height (in m): kg/(m**2)
...
# when you use the round() function, the result is returned as a rounded off integer
print(round(8/3))
    # 3
...
#Manipulation 
#You can also store the result as a variable and continue to work on it. eg.:
result = 4/2
print(result/2)
    # 1.0
...
#Round the answer off to 2 decimal places.
